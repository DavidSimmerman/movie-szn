...
>
	<div
		class="text-mono absolute top-1/2 left-4 z-10 -translate-y-1/2 rounded-full border border-[color:var(--color-accent)] bg-[color:var(--color-bg)] px-3 py-1 text-[0.6rem] tracking-[0.3em] text-[color:var(--color-accent)] uppercase"
	>
		{seasonName}
	</div>
	<div class="marquee-wrap pl-[14rem]">
