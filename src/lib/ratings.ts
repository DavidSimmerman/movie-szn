...
export const CATEGORIES = [
	...
	{ key: 'misc', label: 'misc', hint: 'humor, world, vibes' },
...
export function combinedScore(r: RatingBreakdown): number {
	return ((r.production + r.storyPlot + r.misc + r.daveFactor) / 4) * 2;
}
...
/** Display score like "9.75" or "12.00". Always 2 decimal places. */
